...
# OPEN ALEMBIC
#bpy.ops.wm.alembic_import(filepath=file_fbx, filter_alembic=True, relative_path=False, scale=1.0, set_frame_range=True,
#                          as_background_job=False)
bpy.ops.import_scene.fbx(filepath=file_fbx)
bpy.ops.transform.resize(value=(100, 100, 100), orient_type='GLOBAL', orient_matrix_type='GLOBAL',
                         center_override=(0.0, 0.0, 0.0),  use_accurate=True)
